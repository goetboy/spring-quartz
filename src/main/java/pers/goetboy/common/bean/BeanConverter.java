...
import pers.goetboy.common.utils.ClassUtils;
...
public class BeanConverter {
    ...
    public static Map<String, TypeConverter> getConverters() {
        registerConverter(new EnumStringConverter(IEnumInterface.class, String.class));
        registerConverter(new EnumStringConverter(String.class, IEnumInterface.class));
